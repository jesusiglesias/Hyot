...
\begin{document}
	...
	\begin{itemize}
		...
		\item \textbf{Capítulo 3 - \nameref{planningChapter}:} describe la gestión del proyecto y la metodología de desarrollo \textit{software} implementada junto con aspectos relacionados con su planificación: organización interna, plan de fases e iteraciones, estimación de costes y gestión de riesgos.		
