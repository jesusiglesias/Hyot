...
\begin{document}
	...
	Todo proyecto requiere de una descripción previa que
        \modified{situé} al lector en el panorama general del mismo,
	...
	Una posible solución es la descentralización de la gestión de
        ...
        (\gls{blockchain-a}), un libro de registros o transacciones
	...
	En su origen, \gls{blockchain-a} se inventó para sustentar
        \gls{bitcoin}, la primera criptomoneda -medio digital de
	...
	Uno de los ámbitos donde \gls{blockchain-a} tiene especial
        ...
        -\gls{iot-a}-). La \gls{iot-a} constituye una red de
	...
	\begin{itemize}
          ...
          \item Conocer qué es \gls{hyperledger} y comprender el
          ...
          \item Conocer los proyectos existentes en \gls{hyperledger}
            ...
            \gls{hyperledgerfabric} (\gls{hyperledgerfabric-a}) y
	...
	Estos sistemas, considerados como complejos y costosos, no han
        ...
        áreas o unidades de negocio. \commented{Frente a este
          escenario, surgieron sistemas tales como las redes sociales
          donde la información se localiza de manera descentralizada
          en múltiples puntos de almacenamiento omitiendo la
          existencia de un almacenamiento central y por tanto el punto
          único de fallo} \comments{supongo que te refieres a las
          redes P2P. En general, las redes sociales no son
          descentralizadas. }. Sin embargo, la falta de una
	...
	\gls{blockchain-a} es un nuevo paradigma llamado a
        \modified{liderar el tránsito de una Internet de la
        ...
        transición implica \modified{modificar} los modelos existentes
        ...
        consenso y confianza distribuida. En primer lugar,
        \modified{el modelo de confianza distribuido deparado por
          tecnología de consenso de la \gls{blockchain-a}} supone un
        ...
        repartida y replicada. \modified{Este factor, unido a la forma en al que
        ...
        de los silos de información. \modified{En definitiva, se habilita} instauración de
	...
	Sin embargo, este nuevo paradigma no siempre es válido o es el
        ...
        formular antes de la toma de decisión:
        \comments{puedes citar este artículo aquí: https://eprint.iacr.org/2017/375.pdf}
	...
	\comments{no viene mal decir que es un concepto amplio, cuya
          definición no está del todo cerrada. No obstante, se pueden
          establecer una serie de elementos comunes a las diversas
          variantes de blockchain. Ten en cuenta, por otro lado,  que
          en Hyperledger no hay minado de bloques. }
	La cadena de bloques o \Gls{blockchain} (\gls{blockchain-a}),
        tipo de tecnología de registro distribuido (\textit{\gls{dlt}}
        -\gls{dlt-a}-), es una estructura de datos distribuida,
        también conocida como libro de registros o \textit{ledger},
        que es replicada y compartida entre todos aquellos miembros
        (nodos) que pertenezcan a una red \gls{p2p-a}
        (\textit{\gls{p2p}}), es decir, una red distribuida
        \comments{No necesariamente tiene que ser replicada por todos
          los nodos. Ten en cuenta que, por ejemplo, en bitcoin o
          ethereum un nodo puedo ser ligero, de forma que en local
          solo tiene una versión reducida de la cadena.}. Este
 ...
 \begin{enumerate}
  ...
  \end{enumerate}
	...
	La tecnología de \gls{blockchain-a} está construida sobre dos
        ...
        siguientes propiedades: \comments{pondría alguna referencia a
          algún libro de criptografía. Por ejemplo, el libro de
          Menezes o el de Schneier.}
	 ...
	 \begin{itemize}
	 	\item Algoritmo de prueba de trabajo (\textit{Proof of
                  ...
                  (DDoS)\footnote{Ataque cuya finalidad es saturar los
                    ...
                    peticiones falsas.}. Este concepto no es nuevo y
                  la idea subyacente fue publicada por Cynthia Dwork y
                  Moni Naor en 1993 \cite{dwork:1993}. \comments{En
                    realidad, hay pocos conceptos realmente nuevos en
                    la blockchain de bitcoin. Por si quieres tenerlo
                    en cuenta: https://queue.acm.org/detail.cfm?id=3136559}
	...
	\comments{Para que lo tengas en cuenta: los smart contracts no
        son contratos en el sentido estricto de la palabra, y tampoco
        son muy inteligentes $\Rightarrow$ https://estsjournal.org/article/download/107/61}
	...
	\begin{itemize}
		...
		\item Quién puede registrar transacciones o
                  ...
                  desplegar \textit{smart contracts} o
                  \textit{\glspl{chaincode}} \comments{no mencionaría
                    los chaincodes hasta estar con hyperledger}, quién posee el privilegio de registrar transacciones \cite{hyperledgercomposer:acl} o quién puede participar en el proceso de minado \cite{multichain:permissions}.
	...
	\begin{itemize}
		\item Mejora la seguridad al evitar información
                  incosistente gracias al consenso de todos
                  \modified{los nodos de la red que tienen una replica
                    de la Blockchain}.
	...
	% Section
	\section{Hyperledger}
	\comments{Lo cierto es que las blockchain públicas no son tan
          descentralizadas y transparentes como proclaman sus
          creadores y defensores:
          http://www0.cs.ucl.ac.uk/staff/S.Meiklejohn/files/bitcoin18b.pdf.
        Además, los smart contracts de Ethereum tienen múltiples
        problemas de seguridad:
        \url{https://link.springer.com/chapter/10.1007\%2F978-3-662-54455-6_8}.
      Por eso, y por la escabilidad y otros temas legales y
      normativos, tiene sentido considerar otros modelos de
      blockchain.}
	...
	El consenso en \gls{hyperledgerfabric-a} es efectuado por los
        ...
        (\textit{Simplified Byzantine Fault Tolerance}, Kafka,
        etc. algunos aún en desarrollo. Éste último \comments{te
          refieres al Kafka ordering service, ¿no? Esta es una de las
          grandes críticas a Hyperledger: finalmente el consenso que
          construye no es tan distribuido. Según han anunciado, se
          espera que en Hyperledger Fabric 1.4 esté PBTF. Lo
          importante, eso sí, es Hyperledger persigue un sentido
          agnóstico: puedes incorporar el modelo de consenso que
          quieras, al menos ese es el objetivo. Esto también se
          persigue con los smart contracts: se quiere que se puede
          ejecutar cualquier tipo de contrato inteligente. } es el método empleado por defecto para redes en producción el cual se basa en la votación permisionada y ofrece tolerancias a fallas pero no tolerancia a fallas bizantinas el cual previene al sistema de alcanzar un acuerdo en caso de nodos maliciosos o defectuosos. Este proceso de consenso está formado por tres fases: validación de transacciones, fase de ordenación de transacciones válidas y validación de bloques y de la exactitud de los resultados. \\
...
\comments{yo pondría aquí la figura con los proyectos}
