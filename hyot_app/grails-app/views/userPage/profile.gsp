...
<head>
    ...
    <script>
        ...
        var _checkEmailProfileAvailibility = '${g.createLink(controller: "secUser", action: 'checkEmailAvailibility')}';
...
<body>
                    ...
                    <div class="col-md-12 col-userLayoutTitle">
                        ...
                        <div class="portlet light">
                            ...
                            <div class="portlet-body">
                                ...
                                <!-- Edit form -->
                                <g:form controller="userPage" action="updatePersonalInfo" method="PUT" autocomplete="on" class="horizontal-form profileUser-form">
    ...
    <asset:javascript src="domain-validation/personalInformation-profile-validation.js"/>
