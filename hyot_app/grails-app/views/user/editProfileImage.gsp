...
<head>
    ...
    <title><g:message code="layouts.main_auth_admin.head.title.user" default="HYOT | Normal user management"/></title>
...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div id="edit-domain">
            ...
            <!-- Edit form -->
            <g:form url="[resource:user, action:'updateProfileImage']" enctype="multipart/form-data" class="horizontal-form profileImage-form">
