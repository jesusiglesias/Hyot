...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <h3 class="page-title">
            ...
            <small><g:message code="layouts.main_auth_admin.body.subtitle.user.create" default="Create normal user"/></small>
        </h3>
        ...
        <div id="create-domain">
            ...
            <!-- Creation form -->
            <g:form url="[resource:user, action:'save']" enctype="multipart/form-data" autocomplete="on" class="horizontal-form user-form">
                <fieldset class="form">
...
<!-- LOAD JAVASCRIPT  -->
<asset:javascript src="select/jquery.quicksearch.js"/>
...
<asset:javascript src="domain-validation/user-validation.js"/>
