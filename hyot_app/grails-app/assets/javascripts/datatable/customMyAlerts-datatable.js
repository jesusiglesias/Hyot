...
var DatatableAlertList = function () {
    ...
    var initAlertTable = function () {
        ...
        var oTable = table.dataTable({
            ...
            buttons: [
                { extend: 'print', className: 'btn dark btn-outline transparent hvr-bounce-to-top-print', text: _print, exportOptions: {columns: [0, 1, 2, 3]} },
                ...
                { extend: 'pdf', className: 'btn green-dark btn-outline transparent hvr-bounce-to-top-pdf', text: _pdf, filename: _myalertFile, title: _myalertTableTitle, exportOptions: {columns: [0, 1, 2, 3, 5, 6]} },
                { extend: 'csv', className: 'btn blue-steel btn-outline transparent hvr-bounce-to-top-csv', text: _csv, fieldSeparator: ';', filename: _myalertFile, exportOptions: {columns: [0, 1, 2, 3, 4, 5]} },
