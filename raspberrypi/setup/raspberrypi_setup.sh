...
PACKAGESTOINSTALL="python2.7 build-essential python-dev python-smbus python-pip gnupg rng-tools i2c-tools"                  # Packages to install
LIBRARYTOINSTALL="PyYAML psutil pyfiglet colorama RPi.GPIO gpiozero RPLCD python-gnupg picamera ibmiotf cloudant dropbox"   # Libraries to install
